...
(function(){
    ...
    WEBSTORE.admin.create = function(){
...
(function() {
    ...
    WEBSTORE.admin.delete = function(){
...
(function(){
    ...
    WEBSTORE.admin.changeEvent = function(){
        $('#product-category').on('change', function(){
            var category_id = $('#product-category' + ' option:selected').val();
            $('#product-subcategory').html('Select sub category');
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(subcategories.length){
                        ...
                        $('#product-subcategory').append('<option value="">No subcategories found</option>');
                    }
                }
            });
        });
...
(function(){
    ...
    WEBSTORE.admin.update = function(){
...
(function() {
    ...
    WEBSTORE.category.productfilter = function () {
...
(function () {
    ...
    WEBSTORE.product.details = function () {
        var app = new Vue({
            el: '#product',
            data:{
                product: [],
